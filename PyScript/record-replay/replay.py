...
try:
    call([mmwebreplay, os.path.join(repo, web), mmdelay, '0', os.path.join(repo, web), '--', mmlink, 'trace_file', 'trace_file', '--', 'python3', 'chrome.py', url], timeout=60, env=os.environ.copy())
